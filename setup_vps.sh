...
# --- PHÂN BỔ DYNAMIC TIER THEO ĐÚNG MATRIX PHẦN CỨNG ---
TIER_NAME=""
if (( MEM_MB <= 2500 )); then
...
# --- [BẢO VỆ CHÍ MẠNG] ĐỒNG BỘ THỜI GIAN NTP CHUẨN XÁC CHỐNG BAN ACC ---
if has_systemd; then
...
# --- CẤU HÌNH ZRAM ZSTD PRIORITY 10 CHUẨN TUYỆT ĐỐI ---
